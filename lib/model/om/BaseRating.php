...
abstract class BaseRating extends BaseObject  implements Persistent {
  ...
  const PEER = 'RatingPeer';
	...
	/**
	 * The value for the total_sum field.
	 * @var        int
	 */
	protected $total_sum;
	...
	/**
	 * Get the [total_sum] column value.
	 * 
	 * @return     int
	 */
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = RatingPeer::TYPE;
		}
	...
	public function setTypeId($v)
	{
		...
		if ($this->type_id !== $v) {
			$this->type_id = $v;
			$this->modifiedColumns[] = RatingPeer::TYPE_ID;
		}
	...
	/**
	 * Set the value of [total_sum] column.
	 * 
	 * @param      int $v new value
	 * @return     Rating The current object (for fluent API support)
	 */
	public function setTotalSum($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->total_sum !== $v) {
			$this->total_sum = $v;
			$this->modifiedColumns[] = RatingPeer::TOTAL_SUM;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ( $this->created_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = RatingPeer::CREATED_ON;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->type_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->total_sum = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->created_on = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			return $startcol + 5; // 5 = RatingPeer::NUM_COLUMNS - RatingPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aBook !== null && $this->type_id !== $this->aBook->getIsbn10()) {
			$this->aBook = null;
		}
	} // ensureConsistency
    ...
    if ($this->isNew() && !$this->isColumnModified(RatingPeer::CREATED_ON))
    {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setTotalSum($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RatingPeer::TYPE)) $criteria->add(RatingPeer::TYPE, $this->type);
		if ($this->isColumnModified(RatingPeer::TYPE_ID)) $criteria->add(RatingPeer::TYPE_ID, $this->type_id);
		if ($this->isColumnModified(RatingPeer::TOTAL_SUM)) $criteria->add(RatingPeer::TOTAL_SUM, $this->total_sum);
		if ($this->isColumnModified(RatingPeer::CREATED_ON)) $criteria->add(RatingPeer::CREATED_ON, $this->created_on);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTotalSum($this->total_sum);
	...
	{
		if ($this->aBook === null && (($this->type_id !== "" && $this->type_id !== null))) {
			$c = new Criteria(BookPeer::DATABASE_NAME);
			$c->add(BookPeer::ISBN10, $this->type_id);
