...
abstract class BaseCommentPeer {
	...
	const ISBN10 = 'comment.ISBN10';

	/** the column name for the CONTENT field */
	const CONTENT = 'comment.CONTENT';

	/** the column name for the CREATED_ON field */
	const CREATED_ON = 'comment.CREATED_ON';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Isbn10', 'Content', 'CreatedOn', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'isbn10', 'content', 'createdOn', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::ISBN10, self::CONTENT, self::CREATED_ON, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'isbn10', 'content', 'created_on', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Isbn10' => 2, 'Content' => 3, 'CreatedOn' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'isbn10' => 2, 'content' => 3, 'createdOn' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::ISBN10 => 2, self::CONTENT => 3, self::CREATED_ON => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'isbn10' => 2, 'content' => 3, 'created_on' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CommentPeer::ISBN10);

		$criteria->addSelectColumn(CommentPeer::CONTENT);

		$criteria->addSelectColumn(CommentPeer::CREATED_ON);
    ...
    foreach (sfMixer::getCallables('BaseCommentPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCommentPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseCommentPeer', $criteria, $con);
    }
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CommentPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
	...
	public static function doCountJoinBook(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CommentPeer::ISBN10,), array(BookPeer::ISBN10,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseCommentPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseCommentPeer', $c, $con);
    }
		...
		$c->addJoin(array(CommentPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Comment objects pre-filled with their Book objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Comment objects.
	...
	public static function doSelectJoinBook(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(CommentPeer::ISBN10,), array(BookPeer::ISBN10,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comment) to $obj2 (Book)
				$obj2->addComment($obj1);
    ...
    foreach (sfMixer::getCallables('BaseCommentPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseCommentPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Comment) to the collection in $obj3 (Book)
    ...
    foreach (sfMixer::getCallables('BaseCommentPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseCommentPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = CommentPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Comment) to the collection in $obj2 (Book)
				$obj2->addComment($obj1);
	...
	/**
	 * Selects a collection of Comment objects pre-filled with all related objects except Book.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
