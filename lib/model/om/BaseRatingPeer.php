...
/**
 * Base static class for performing query and update operations on the 'rating' table.
 *
 * 
 *
...
abstract class BaseRatingPeer {
	...
	const TYPE_ID = 'rating.TYPE_ID';

	/** the column name for the TOTAL_SUM field */
	const TOTAL_SUM = 'rating.TOTAL_SUM';

	/** the column name for the CREATED_ON field */
	const CREATED_ON = 'rating.CREATED_ON';

	/** the column name for the ID field */
	const ID = 'rating.ID';

	/**
	 * An identiy map to hold any loaded instances of Rating objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Type', 'TypeId', 'TotalSum', 'CreatedOn', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('type', 'typeId', 'totalSum', 'createdOn', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::TYPE, self::TYPE_ID, self::TOTAL_SUM, self::CREATED_ON, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('type', 'type_id', 'total_sum', 'created_on', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Type' => 0, 'TypeId' => 1, 'TotalSum' => 2, 'CreatedOn' => 3, 'Id' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('type' => 0, 'typeId' => 1, 'totalSum' => 2, 'createdOn' => 3, 'id' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::TYPE => 0, self::TYPE_ID => 1, self::TOTAL_SUM => 2, self::CREATED_ON => 3, self::ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('type' => 0, 'type_id' => 1, 'total_sum' => 2, 'created_on' => 3, 'id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new RatingMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RatingPeer::TYPE);

		$criteria->addSelectColumn(RatingPeer::TYPE_ID);

		$criteria->addSelectColumn(RatingPeer::TOTAL_SUM);

		$criteria->addSelectColumn(RatingPeer::CREATED_ON);
    ...
    foreach (sfMixer::getCallables('BaseRatingPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseRatingPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseRatingPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseRatingPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      Rating $value A Rating object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Rating $obj, $key = null)
	{
	...
	public static function doCountJoinBook(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(RatingPeer::TYPE_ID,), array(BookPeer::ISBN10,), $join_behavior);
	...
	/**
	 * Selects a collection of Rating objects pre-filled with their Book objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseRatingPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseRatingPeer', $c, $con);
    }
		...
		$startcol = (RatingPeer::NUM_COLUMNS - RatingPeer::NUM_LAZY_LOAD_COLUMNS);
		BookPeer::addSelectColumns($c);

		$c->addJoin(array(RatingPeer::TYPE_ID,), array(BookPeer::ISBN10,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Rating) to $obj2 (Book)
				$obj2->addRating($obj1);
    ...
    foreach (sfMixer::getCallables('BaseRatingPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseRatingPeer', $c, $con);
    }
		...
		RatingPeer::addSelectColumns($c);
		$startcol2 = (RatingPeer::NUM_COLUMNS - RatingPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Rating) to the collection in $obj2 (Book)
				$obj2->addRating($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Rating or Criteria object.
	 *
    ...
    foreach (sfMixer::getCallables('BaseRatingPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseRatingPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
		...
		if ($criteria->containsKey(RatingPeer::ID) && $criteria->keyContainsValue(RatingPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.RatingPeer::ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseRatingPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseRatingPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Rating or Criteria object.
	 *
    ...
    foreach (sfMixer::getCallables('BaseRatingPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseRatingPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseRatingPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseRatingPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the rating table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Rating or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Rating) {
...
//
// NOTE: This static code cannot call methods on the RatingPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the RatingPeer class:
//
// Propel::getDatabaseMap(RatingPeer::DATABASE_NAME)->addTableBuilder(RatingPeer::TABLE_NAME, RatingPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseRatingPeer::DATABASE_NAME)->addTableBuilder(BaseRatingPeer::TABLE_NAME, BaseRatingPeer::getMapBuilder());
