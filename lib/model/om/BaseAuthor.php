...
abstract class BaseAuthor extends BaseObject  implements Persistent {
  ...
  const PEER = 'AuthorPeer';
	...
	public function setIsbn10($v)
	{
		...
		if ($this->isbn10 !== $v) {
			$this->isbn10 = $v;
			$this->modifiedColumns[] = AuthorPeer::ISBN10;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AuthorPeer::ISBN10)) $criteria->add(AuthorPeer::ISBN10, $this->isbn10);
