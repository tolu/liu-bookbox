...
abstract class BaseBookPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Isbn10', 'Isbn13', 'Title', 'Description', 'Imagepath', 'Published', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('isbn10', 'isbn13', 'title', 'description', 'imagepath', 'published', ),
		BasePeer::TYPE_COLNAME => array (self::ISBN10, self::ISBN13, self::TITLE, self::DESCRIPTION, self::IMAGEPATH, self::PUBLISHED, ),
		BasePeer::TYPE_FIELDNAME => array ('isbn10', 'isbn13', 'title', 'description', 'imagePath', 'published', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Isbn10' => 0, 'Isbn13' => 1, 'Title' => 2, 'Description' => 3, 'Imagepath' => 4, 'Published' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('isbn10' => 0, 'isbn13' => 1, 'title' => 2, 'description' => 3, 'imagepath' => 4, 'published' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ISBN10 => 0, self::ISBN13 => 1, self::TITLE => 2, self::DESCRIPTION => 3, self::IMAGEPATH => 4, self::PUBLISHED => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('isbn10' => 0, 'isbn13' => 1, 'title' => 2, 'description' => 3, 'imagePath' => 4, 'published' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(BookPeer::ISBN10);

		$criteria->addSelectColumn(BookPeer::ISBN13);

		$criteria->addSelectColumn(BookPeer::TITLE);

		$criteria->addSelectColumn(BookPeer::DESCRIPTION);

		$criteria->addSelectColumn(BookPeer::IMAGEPATH);

		$criteria->addSelectColumn(BookPeer::PUBLISHED);
    ...
    foreach (sfMixer::getCallables('BaseBookPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseBookPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseBookPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseBookPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseBookPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(BookPeer::ISBN10);
			$selectCriteria->add(BookPeer::ISBN10, $criteria->remove(BookPeer::ISBN10), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(BookPeer::ISBN10, (array) $values, Criteria::IN);
		...
		try {
			...
			// invalidate objects in AuthorPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Author objects
			$c = new Criteria(AuthorPeer::DATABASE_NAME);
			
			$c->add(AuthorPeer::ISBN10, $obj->getIsbn10());
			$affectedRows += AuthorPeer::doDelete($c, $con);

			// delete related Rating objects
			$c = new Criteria(RatingPeer::DATABASE_NAME);
			
			$c->add(RatingPeer::TYPE_ID, $obj->getIsbn10());
			$affectedRows += RatingPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(BookPeer::ISBN10, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(BookPeer::DATABASE_NAME);
			$criteria->add(BookPeer::ISBN10, $pks, Criteria::IN);
