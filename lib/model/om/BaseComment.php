...
abstract class BaseComment extends BaseObject  implements Persistent {
  ...
  const PEER = 'CommentPeer';
	...
	public function setIsbn10($v)
	{
		...
		if ($this->isbn10 !== $v) {
			$this->isbn10 = $v;
			$this->modifiedColumns[] = CommentPeer::ISBN10;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ( $this->created_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = CommentPeer::CREATED_ON;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->isbn10 = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = CommentPeer::NUM_COLUMNS - CommentPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(CommentPeer::CREATED_ON))
    {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setIsbn10($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CommentPeer::ISBN10)) $criteria->add(CommentPeer::ISBN10, $this->isbn10);
		if ($this->isColumnModified(CommentPeer::CONTENT)) $criteria->add(CommentPeer::CONTENT, $this->content);
		if ($this->isColumnModified(CommentPeer::CREATED_ON)) $criteria->add(CommentPeer::CREATED_ON, $this->created_on);
