			<?php	echo image_tag("/uploads/profileImages/".$user->getImagePath().".jpg"); ?> 	
			<h1 class="spacerElement"><?php echo $user->getFname()." ".$user->getLname() ;?></h1>
			<?php if($editable): ?>

							<a href="<?php echo url_for('teacher/editProfile?userID='.$user->getId());?>"  id="editProfileBtn" class="profileAjaxLink floatRight ui-state-default ui-corner-all"><span class='ui-icon ui-icon-wrench'></span>Ändra</a>
